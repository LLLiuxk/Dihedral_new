...
int main()
{
	...
	if (f == 1) //specify
	{
		// 5: 6,11,16,29   13: 1,12,27,36  14: 0,4,17,24   22: 8,19,28,36   28: 6,23,25,35  31: 0,15,18,27
		//44:6,19,24,31    71:4,14,22,32    70: 0,8,19,28    192: 0,9,18,27   157:6,12,23,31
		vector<int> anc_points = { 0,8,19,28 };
		tiling.tiliing_gen_specify2("70", anc_points);
