...
namespace Tiling_tiles {
	...
	public:
		...
		vector<Point_f> contour_opt(vector<Point_f> cont, vector<int> anc_p, int type, bool pers_trans=true,	bool coll_opt = false, bool deve_opt = false); //type: 0=contours bbx; 1: square bbx
