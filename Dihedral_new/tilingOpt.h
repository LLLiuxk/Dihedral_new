...
namespace Tiling_tiles {
	...
	public:
		...
		vector<pair<int, bool>> compare_TAR(vector<Point2f> contour_mid, int chosen_num, int window_width = WindowsWidth); //chosen_num  选择的最终结果的数目
	...
	public:
		...
		vector<vector<vector<Point_f>>> candidate_contours;
